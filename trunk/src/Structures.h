...
struct SShadowMapAttribs
{
    ...
    Matrix4 mWorldToShadowMapUVDepthT[MAX_CASCADES];
#else
...
struct SPostProcessingAttribs
{
    ...
    int m_bShowSampling; 
    int m_bCorrectScatteringAtDepthBreaks; 
    int m_bShowDepthBreaks; 

    int m_bShowLightingOnly;
    int m_bOptimizeSampleLocations;
    int m_bEnableLightShafts;
